---
layout: nbpost
title: MD test - default converter
...
The examples in this article will focus on the **Simple Moving Average (SMA)**. Its construction is quite simple: we first define a rolling window of length $n$ (in our example a whole number of days in our example - let's use $n=5$). We then start from day 5 and consider all the prices from day 1 to day 5 (included). We compute the arithmetic mean of those prices (by summing them up and dividing by 5): that is the value of our SMA for day 5. Then, we move on to day 6, we take out the price on day 1 and include the price on day 6 and compute the next SMA. We keep repeating the process until we reach the last price in our series. See the table:
...
```
    ...
    <matplotlib.axes._subplots.AxesSubplot at 0x114933790>
...
```
    ...
    <matplotlib.legend.Legend at 0x115dfbbd0>
...
```
    ...
    <matplotlib.legend.Legend at 0x104522250>




![png](/assets/images/TTB01%20-%20Simple%20Moving%20Average_22_1.png)
...
```
    ...
    <matplotlib.axes._subplots.AxesSubplot at 0x1160c0c50>




![png](/assets/images/TTB01%20-%20Simple%20Moving%20Average_26_1.png)
...
```
    ...
    <matplotlib.legend.Legend at 0x103742c90>




![png](/assets/images/TTB01%20-%20Simple%20Moving%20Average_28_1.png)
...
![Two MAs](/assets/images/fig03.png)
...
```
    ...
    <matplotlib.legend.Legend at 0x1164b9d50>




![png](/assets/images/TTB01%20-%20Simple%20Moving%20Average_31_1.png)
...
![Three MAs](/assets/images/fig04.png)
![Three MAs](/assets/images/fig05.png)
